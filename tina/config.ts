      ...
      },
      {
        ...
        fields: [
          ...
          },
          {
            type: "string" as const,
            name: "caption",
            label: "Pie de foto (lugar o contexto de la imagen)",
          },
          {
            type: "string" as const,
            name: "image_position",
            label: "Encuadre (object-position)",
            description: "Qué parte de la foto se muestra cuando hay recorte.",
            options: [
          ...
          },
          {
            type: "string" as const,
            name: "image_fit",
            label: "Ajuste (object-fit)",
            description: "cover = recorta para llenar; contain = muestra la imagen completa.",
          ...
          },
          {
            ...
            description: "Fuerza una proporción. Vacío = tamaño natural.",
            options: ["4/3", "3/2", "16/9", "1/1", "21/9", "9/16", "2/3", "3/4"],
          },
        ],
      },
      {
